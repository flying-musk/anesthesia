...
export const translations = {
  en: {
    ...
    createMedicalHistory: 'Create Medical History',
    ...
    sedationAnesthesia: 'Sedation Anesthesia',
    surgeryDuration: 'Surgery Duration (minutes)',
    anesthesiaDuration: 'Anesthesia Duration (minutes)',
    preSurgeryAssessment: 'Pre-Surgery Assessment',
    postSurgeryNotes: 'Post-Surgery Notes',
    complications: 'Complications',
    createSurgeryRecord: 'Create Surgery Record',
  },
  zh: {
    // Navigation
    dashboard: '儀表板',
    ...
    otherMedicalInfo: '其他醫療信息',
    saving: '保存中...',
    updateMedicalHistory: '更新醫療病史',
    createMedicalHistory: '創建醫療病史',
    surgeryType: '手術類型',
    selectSurgeryType: '選擇手術類型',
    generalAnesthesia: '全身麻醉',
    localAnesthesia: '局部麻醉',
    regionalAnesthesia: '區域麻醉',
    sedationAnesthesia: '鎮靜麻醉',
    surgeryDuration: '手術時長（分鐘）',
    anesthesiaDuration: '麻醉時長（分鐘）',
    preSurgeryAssessment: '術前評估',
    postSurgeryNotes: '術後記錄',
    complications: '併發症',
    createSurgeryRecord: '創建手術記錄',
  },
  fr: {
    // Navigation
    ...
    updateMedicalHistory: 'Mettre à jour les Antécédents Médicaux',
    createMedicalHistory: 'Créer les Antécédents Médicaux',
    surgeryType: 'Type de Chirurgie',
    selectSurgeryType: 'Sélectionner le type de chirurgie',
    generalAnesthesia: 'Anesthésie Générale',
    localAnesthesia: 'Anesthésie Locale',
    regionalAnesthesia: 'Anesthésie Régionale',
    sedationAnesthesia: 'Anesthésie Sédative',
    surgeryDuration: 'Durée de Chirurgie (minutes)',
    anesthesiaDuration: 'Durée d\'Anesthésie (minutes)',
    preSurgeryAssessment: 'Évaluation Pré-Chirurgicale',
    postSurgeryNotes: 'Notes Post-Chirurgicales',
    complications: 'Complications',
    createSurgeryRecord: 'Créer un Dossier de Chirurgie',
  },
};
