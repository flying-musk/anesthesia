...
class MedicalMultilingualService:
    ...
    def __init__(self):
        self.supported_languages = [LanguageEnum.EN, LanguageEnum.ZH, LanguageEnum.FR, LanguageEnum.ES, LanguageEnum.JA, LanguageEnum.KO]
    ...
    def _get_mock_translation(self, text: str, target_language: LanguageEnum) -> str:
        ...
        medical_translations = {
            ...
            LanguageEnum.ES: {
                ...
                "Patient assessed for": "Paciente evaluado por",
                "Vital signs stable": "Signos vitales estables",
                "No contraindications": "Sin contraindicaciones",
                "Patient recovered well": "El paciente se recuperó bien",
                "No complications noted": "No se observaron complicaciones",
                "Discharged same day": "Alta el mismo día"
            },
            LanguageEnum.JA: {
                "Penicillin allergy": "ペニシリンアレルギー",
                "Hypertension": "高血圧",
                "Blood pressure medication": "降圧薬",
                "None": "なし",
                "No complications": "合併症なし",
                "Patient assessed for": "患者の評価",
                "Vital signs stable": "バイタルは安定",
                "No contraindications": "禁忌なし",
                "Patient recovered well": "患者は順調に回復しました",
                "No complications noted": "合併症は記録されていません",
                "Discharged same day": "同日退院"
            },
            LanguageEnum.KO: {
                "Penicillin allergy": "페니실린 알레르기",
                "Hypertension": "고혈압",
                "Blood pressure medication": "혈압약",
                "None": "없음",
                "No complications": "합병증 없음",
                "Patient assessed for": "환자 평가",
                "Vital signs stable": "활력징후 안정",
                "No contraindications": "금기사항 없음",
                "Patient recovered well": "환자가 잘 회복했습니다",
                "No complications noted": "합병증 없음으로 기록됨",
                "Discharged same day": "당일 퇴원"
            }
        }
